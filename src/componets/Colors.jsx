...
function Colors() {
    ...
    const colors = [
        {id: 'blue', name: 'Titânio Azul', image: '/public/iphone-blue.jpg', colorClass: 'bg-blue-500'},
        {id: 'silver', name: 'Titânio Natural', image: '/public/iphone-silver.jpg', colorClass: 'bg-gray-300'},
        {id: 'orange', name: 'Titânio Laranja', image: '/public/iphone-orange.jpg', colorClass: 'bg-orange-500'},
    ]   

    const models = [
        {name: 'Pro Max', screen: '6.9 polegadas', storage: '256GB, 512GB ou 1TB', battery: '33h de vídeo', wieght: '221g'},
        {name: 'Pro', screen: '6.3 polegadas', storage: '128GB, 256GB ou 512GB', battery: '29h de vídeo', wieght: '199g'},
    ]
    ...
    return (
      <section id='colors' className='bg-black py-20 px-8'>
        <div className='max-w-7xl mx-auto' id='colors'>
            ...
            <div className='relative w-full max-w-3xl '>
              <div className='relative flex justify-center items-center min-h-125'>
                <img
                  ...
                  alt='iphone 17'
                  className='max-w-full mas-h-[600px] mx-auto'
                />
              </div>
          ...
          <div className='flex justify-center items-centera gap-4'>
            {colors.map((color) => (
              <button
                key={color.id}
                ...
                <div
                  className={`w-16 h-16 rounded-full border-4 ${color.colorClass} ${selectedColor === color.id ? 'border-white' : 'border-gray-600'}`}></div>
              </button>
            ))}
          </div>
          ...
          <div className='text-center mt-16'>
            <button className='bg-blue-700 hover:bg-blue-800 text-white px-12 py-4 rounded-full text-lg font-medium transition-all duration-300 mb-6 hover:scale-105 shadow-md shadow-blue-500/50 cursor-pointer'>
              Compre agora á partir de R$ 9.299
            </button>
            <p className=''>Ou em até 12x de R$ 774,92 sem juros</p>
          </div>
        </div>
      </section>
    );
