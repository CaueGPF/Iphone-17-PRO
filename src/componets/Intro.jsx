      ...
      <section className='bg-black py-20 px-6'>
        <div className='max-w-5xl mx-auto text-center'>
          ...
          <p className='text-lg md:text-xl text-gray-300 mb-10 max-w-3xl mx-auto'>
            O design mais refinado que já criamos. Titânio de grau aeroespacial. Chip A18 Pro.
            <br></br>
        ...
        <div className='flex flex-col sm:flex-row gap-4 justify-center items-center mb-16'>
          <button className='bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-full text-lg font-medium transition-all durant-300 hover:scale-105 shadow-lg shadow-blue-500/50 cursor-pointer'>
            Compre agora
          </button>
          <button className='border-2 border-white bg-transparent text-white rounded-full hover:bg-white hover:text-black px-8 py-4 text-lg font-medium transition-all duration-300 hover:scale-105 cursor-pointer'>
            Saiba mais
          </button>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mx-auto max-w-5xl">
          {specs.map((spec, index) => (
            <div key={index} className='bg-gray-900 p-6 rounded-2xl hover:bg-gray-600 transition-all duration-300 hover:scale-105'>
